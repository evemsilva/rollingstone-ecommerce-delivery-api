...
public abstract class AbstractController
    ...
    private final Counter http400ExceptionCounter = Metrics.counter("com.rollingstone.DeliveryController.HTTP400");
    private final Counter http404ExceptionCounter = Metrics.counter("com.rollingstone.DeliveryController.HTTP404");
